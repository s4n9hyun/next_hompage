...
function getClient(s3Config) {
  ...
  var client = new clientS3.S3Client(_extends({
    credentials: {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 15:
              ...
              _context.next = 23;
              return s3RequestPresigner.getSignedUrl(client, new clientS3.PutObjectCommand(params), {
                expiresIn: 60 * 60
              });
            case 23:
              url = _context.sent;
            ...
            case 27:
              ...
              sts = new clientSts.STSClient(stsConfig);
...
var FileInput = /*#__PURE__*/React.forwardRef(function (_ref, forwardedRef) {
  var _ref$onChange = _ref.onChange,
    onChange = _ref$onChange === void 0 ? function () {} : _ref$onChange,
    restOfProps = _objectWithoutPropertiesLoose(_ref, _excluded$1);
  var handleChange = function handleChange(event) {
    var _event$target, _event$target$files;
    var file = (_event$target = event.target) == null ? void 0 : (_event$target$files = _event$target.files) == null ? void 0 : _event$target$files[0];
    onChange(file, event);
...
var useUploadFiles = function useUploadFiles() {
  ...
  return {
    FileInput: function FileInput$1(props) {
      return React__default.createElement(FileInput, Object.assign({}, props, {
        ref: ref,
        style: {
          display: 'none'
        }
...
var useUploader = function useUploader(strategy, uploader) {
...
var getUploadParams = /*#__PURE__*/function () {
  var _ref2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(strategy, file, requestOptions) {
    ...
    var filename, additionalBody, additionalHeaders, apiRouteUrl, body, headers, res;
...
var usePresignedUpload = function usePresignedUpload() {
  var hook = useUploader('presigned', upload);
  return hook;
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            command = new clientS3.GetObjectCommand({
              Bucket: config.bucket,
              Key: key
            });
            _context.next = 5;
            return s3RequestPresigner.getSignedUrl(client, command, {
              expiresIn: 3600
            });
          case 5:
            url = _context.sent;
...
exports.generateTemporaryUrl = generateTemporaryUrl;
exports.getImageData = getImageData;
exports.sanitizeKey = sanitizeKey;
exports.usePresignedUpload = usePresignedUpload;
